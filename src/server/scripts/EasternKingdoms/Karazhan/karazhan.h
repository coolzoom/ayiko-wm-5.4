...
#define ERROR_INST_DATA(a)          sLog->outError("scripts", "Instance Data for Karazhan not set properly. Encounter for Creature Entry %u may not work properly.", a->GetEntry());
#endif
