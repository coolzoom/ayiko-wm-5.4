...
--
-- Host: localhost    Database: auth_mop
-- ------------------------------------------------------
...
) ENGINE=InnoDB AUTO_INCREMENT=99 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='Account System';
...
CREATE TABLE `ip_banned` (
  ...
  `prefix_size` tinyint(3) unsigned NOT NULL DEFAULT '32',
  `bandate` bigint(40) NOT NULL,
  `unbandate` bigint(40) NOT NULL,
  `bannedby` varchar(50) NOT NULL DEFAULT '[Console]',
  `banreason` varchar(255) NOT NULL DEFAULT 'no reason',
  PRIMARY KEY (`ip`,`prefix_size`,`bandate`)
...
) ENGINE=MyISAM AUTO_INCREMENT=22 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='Realm System';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `realmlist` VALUES (1,'Trinity','127.0.0.1','127.0.0.1','255.255.255.0',8085,0,0,1,0,0,17399);
...
--
-- Dumping data for table `spam_keywords`
--

LOCK TABLES `spam_keywords` WRITE;
/*!40000 ALTER TABLE `spam_keywords` DISABLE KEYS */;
/*!40000 ALTER TABLE `spam_keywords` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2015-02-06 20:38:04
