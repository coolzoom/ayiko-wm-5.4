    ...
    public:
        ...
        struct mob_xian_the_weaponmaster_trigger_AI : public ScriptedAI
        {
            ...
            void MoveInLineOfSight(Unit* who)
            {
                ...
                if (!event_go && who->GetTypeId() == TYPEID_PLAYER && who->GetAreaId() == 6471)//Salle de l'assembl�e cramoisie
                {
...
class mob_adepts : public CreatureScript
{
    public:
        ...
        struct mob_adepts_AI : public ScriptedAI
        {
            ...
            void MoveInLineOfSight(Unit* who)
            {
                if (who->GetTypeId() == TYPEID_PLAYER && who->GetAreaId() == 6471//Salle de l'assembl�e cramoisie
