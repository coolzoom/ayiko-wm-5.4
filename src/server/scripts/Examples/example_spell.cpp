    ...
    public:
        ...
        class spell_ex_5581SpellScript : public SpellScript
        {
            ...
            void HandleBeforeCast()
            {
                ...
                sLog->outInfo("misc", "Caster just finished preparing the spell (cast bar has expired)");
            }
            ...
            void HandleOnCast()
            {
                ...
                sLog->outInfo("misc", "Spell is about to do take reagents, power, launch missile, do visuals and instant spell effects");
            }

            void HandleAfterCast()
            {
                sLog->outInfo("misc", "All immediate Actions for the spell are finished now");
            ...
            {
                sLog->outInfo("misc", "Spell %u with SPELL_EFFECT_DUMMY is just launched!", GetSpellInfo()->Id);
            }
            ...
            void HandleDummyLaunchTarget(SpellEffIndex /*effIndex*/)
            {
                ...
                sLog->outInfo("misc", "Spell %u with SPELL_EFFECT_DUMMY is just launched at it's target: " UI64FMTD "!", GetSpellInfo()->Id, targetGUID);
            }

            void HandleDummyHit(SpellEffIndex /*effIndex*/)
            {
                sLog->outInfo("misc", "Spell %u with SPELL_EFFECT_DUMMY has hit!", GetSpellInfo()->Id);
            }

            void HandleDummyHitTarget(SpellEffIndex /*effIndex*/)
            {
                sLog->outInfo("misc", "SPELL_EFFECT_DUMMY is hits it's target!");
            ...
            {
                sLog->outInfo("misc", "Spell is about to hit target!");
            }

            void HandleOnHit()
            {
                sLog->outInfo("misc", "Spell just hit target!");
            }

            void HandleAfterHit()
            {
                sLog->outInfo("misc", "Spell just finished hitting target!");
            }

            void FilterTargets(std::list<Unit*>& /*targetList*/)
            {
                // usually you want this call for Area Target spells
                sLog->outInfo("misc", "Spell is about to add targets from targetList to final targets!");
            }
...
class spell_ex_66244 : public SpellScriptLoader
{
    public:
        ...
        class spell_ex_66244AuraScript : public AuraScript
        {
            ...
            {
                sLog->outInfo("misc", "Aura Effect is about to be applied on target!");
            ...
            {
                sLog->outInfo("misc", "Aura Effect is about to be removed from target!");
                // this hook allows you to prevent execution of AuraEffect handler, or to replace it with your own handler
                //PreventDefaultAction();
            }
            ...
            {
                sLog->outInfo("misc", "Aura Effect has just been applied on target!");
            ...
            {
                sLog->outInfo("misc", "Aura Effect has just been just removed from target!");
                Unit* target = GetTarget();
            ...
            {
                sLog->outInfo("misc", "Perioidic Aura Effect is does a tick on target!");
                Unit* target = GetTarget();
            ...
            {
                sLog->outInfo("misc", "Perioidic Aura Effect is now updated!");
            ...
            {
                sLog->outInfo("misc", "Amount of Aura Effect is being calculated now!");
            ...
            {
                sLog->outInfo("misc", "Periodic data of Aura Effect is being calculated now!");
            ...
            {
                sLog->outInfo("misc", "SpellMod data of Aura Effect is being calculated now!");
...
class spell_ex_absorb_aura : public SpellScriptLoader
{
    public:
        ...
        class spell_ex_absorb_auraAuraScript : public AuraScript
        {
            ...
            {
                sLog->outInfo("misc", "Our aura is now absorbing damage done to us!");
            ...
            {
                sLog->outInfo("misc", "Our aura has absorbed %u damage!", absorbAmount);
            }
...
class spell_ex_463 : public SpellScriptLoader
{
    public:
        ...
        class spell_ex_463AuraScript : public AuraScript
        {
            ...
            {
                sLog->outInfo("misc", "Area aura checks if unit is a valid target for it!");
