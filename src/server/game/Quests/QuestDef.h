...
enum QuestFlags
{
    ...
    QUEST_FLAGS_SOR_WHITE_LIST            = 0x00800000,   // Found in quest 14069
    ...
    QUEST_FLAGS_SHOW_ITEMS_WHEN_COMPLETED = 0x10000000,
    ...
    QUEST_ALLOWED_FLAGS_MASK              = 0x000FFFFF
};
...
{
    QuestStatusData()
        : Status(QUEST_STATUS_NONE), Timer(0), Explored(false) { }
