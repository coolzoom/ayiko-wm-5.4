...
namespace FactorySelector
{
    CreatureAI* selectAI(Creature* creature)
    {
        ...
        sLog->outDebug("scripts", "Creature %u used AI is %s.", creature->GetGUIDLow(), ainame.c_str());
    ...
    GameObjectAI* SelectGameObjectAI(GameObject* go)
    {
        ...
        sLog->outDebug("scripts", "GameObject %u used AI is %s.", go->GetGUIDLow(), ainame.c_str());
