...
ALTER TABLE `game_event_model_equip` MODIFY `eventEntry` MEDIUMINT(8) UNSIGNED NOT NULL COMMENT 'Entry of the game event.';
...
ALTER TABLE `game_event_pool` MODIFY `eventEntry` MEDIUMINT(8) UNSIGNED NOT NULL COMMENT 'Entry of the game event.';
...
ALTER TABLE `game_event_creature` MODIFY `eventEntry` MEDIUMINT(8) UNSIGNED NOT NULL COMMENT 'Entry of the game event. Put negative entry to remove during event.';
ALTER TABLE `game_event_gameobject` MODIFY `eventEntry` MEDIUMINT(8) UNSIGNED NOT NULL COMMENT 'Entry of the game event. Put negative entry to remove during event.';