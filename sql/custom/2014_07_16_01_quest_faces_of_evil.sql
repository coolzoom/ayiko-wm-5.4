...
UPDATE `quest_template` SET `Method` = 2, `Flags` = 8 WHERE `Id` = 26521;
...
DELETE FROM `conditions` WHERE `SourceTypeOrReferenceId` = 13 AND `SourceGroup` = 1 AND `SourceEntry` = 79513;
