...
enum CharacterDatabaseStatements
{
    ...
    */
    ...
    CHAR_SEL_CHARACTER_CP_WEEK_CAP,
    CHAR_REP_CHARACTER_CP_WEEK_CAP,
    CHAR_UPD_CHARACTER_CP_WEEK_CAP,
    CHAR_UPD_CURRENCY_WEEK_COUNT,
    CHAR_UPD_ARENA_DATA,
    CHAR_UPD_RATED_BG_STATS,
    ...
    CHAR_SEL_RATED_BG_STATS,
    CHAR_REP_RATED_BG_STATS,
    ...
    CHAR_REP_CHAR_QUESTSTATUS_REWARDED,
    ...
    CHAR_SEL_CHAR_ARCHAEOLOGY,

    CHAR_DEL_CUF_PROFILE,
    CHAR_INS_CUF_PROFILE,
    CHAR_SEL_CUF_PROFILE,

    CHAR_INS_ACCOUNT_SPELL,
    CHAR_SEL_ACCOUNT_SPELL,
    CHAR_DEL_ACCOUNT_SPELL_BY_SPELL,
    ...
    CHAR_SEL_PET_ACTION_BAR,
    CHAR_INS_PET_ACTION_BAR,
    CHAR_UPD_PET_ACTION_BAR,
    CHAR_INS_CURRENT_PET_ID,
    CHAR_DEL_CURRENT_PET_ID,
    CHAR_INS_PET_INFO,
    CHAR_UPD_PET_INFO,
    CHAR_SEL_PET_INFO_BY_ID,
    CHAR_SEL_PET_INFO_BY_ENTRY,
    CHAR_SEL_PET_INFO_BY_SLOT,
    CHAR_SEL_PET_INFO_EXCEPT,
    CHAR_SEL_PET_INFO_FOR_SLOT_CHANGE,
    CHAR_SEL_NEXT_PET_NUMBER,
    CHAR_DEL_PET_INFO_BY_ID,
    CHAR_SEL_PET_SPELL_EXCEPT,
    CHAR_SEL_PET_INFO_LIST,
    CHAR_SEL_PET_SLOT_LIST,
    CHAR_DEL_PET_SLOT_BY_OWNER,
    CHAR_DEL_PET_SLOT_BY_PET_ID,
    CHAR_INS_PET_SLOT,
    CHAR_DEL_PET_DECLINED_NAME,
    CHAR_ADD_PET_DECLINED_NAME,

    // Titles
    CHAR_SEL_CHAR_KNOWN_TITLES,
    CHAR_DEL_CHAR_KNOWN_TITLES,
    CHAR_INS_CHAR_KNOWN_TITLES,
    ...
    // Realm transfer
    CHAR_UPD_TRANSFER_DATA,
    CHAR_SEL_TRANSFER_DATA,
