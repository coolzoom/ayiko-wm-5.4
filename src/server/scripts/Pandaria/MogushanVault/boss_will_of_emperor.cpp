...
{
    { 3810.64f, 1550.48f, 428.737f, 6.27265000f },
    { 3810.70f, 1550.43f, 459.262f, 6.27481000f },
    { 3811.00f, 1550.39f, 367.725f, 6.25210000f },
    { 3811.32f, 1536.29f, 519.944f, 0.19764100f },
    { 3811.62f, 1536.66f, 398.334f, 0.74937700f },
    { 3811.73f, 1536.68f, 489.336f, 0.17836300f },
    { 3811.95f, 1536.81f, 428.738f, 0.17233400f },
    { 3811.99f, 1536.68f, 367.726f, 0.22558000f },
    { 3812.12f, 1550.07f, 398.250f, 0.00872824f },
    { 3812.12f, 1564.02f, 428.738f, 5.77924000f },
    { 3812.33f, 1564.24f, 367.726f, 6.03922000f },
    { 3812.41f, 1563.64f, 489.336f, 5.78941000f },
    { 3812.53f, 1563.66f, 519.944f, 5.78551000f },
    { 3812.83f, 1563.62f, 367.643f, 5.77969000f },
    { 3813.13f, 1563.47f, 398.252f, 5.77872000f },
    { 3813.35f, 1537.36f, 367.643f, 0.15028600f },
    { 3816.55f, 1583.32f, 489.920f, 5.64359000f },
    { 3816.64f, 1516.60f, 489.920f, 0.50946600f },
    { 3816.74f, 1516.60f, 459.844f, 0.51255100f },
    { 3816.99f, 1583.02f, 520.525f, 5.64269000f },
    { 3817.89f, 1517.40f, 520.525f, 0.50370700f },
    { 3831.79f, 1602.73f, 398.912f, 5.41683000f },
    { 3832.32f, 1498.53f, 368.308f, 0.84296200f },
    { 3850.70f, 1613.53f, 368.308f, 5.07364000f },
    { 3851.34f, 1486.52f, 368.308f, 1.23063000f },
    { 3873.66f, 1616.41f, 520.521f, 4.70287000f },
    { 3873.60f, 1616.08f, 459.841f, 4.70587000f },
    { 3873.93f, 1615.60f, 429.237f, 4.68575000f },
    { 3874.22f, 1484.84f, 429.236f, 1.57923000f },
    { 3874.31f, 1483.42f, 368.308f, 1.55837000f },
    { 3874.32f, 1618.01f, 368.308f, 4.71767000f },
    { 3874.39f, 1484.90f, 520.521f, 1.58646000f },
    { 3874.55f, 1483.50f, 398.912f, 1.59109000f },
    { 3874.61f, 1617.90f, 398.912f, 4.75497000f },
    { 3874.70f, 1485.10f, 489.917f, 1.59977000f },
    { 3874.86f, 1484.86f, 459.841f, 1.60658000f },
    { 3894.75f, 1485.93f, 368.308f, 1.48814000f },
    { 3894.93f, 1615.93f, 459.841f, 4.62488000f },
    { 3895.03f, 1483.62f, 398.912f, 1.48814000f },
    { 3895.04f, 1616.19f, 520.521f, 4.61926000f },
    { 3895.24f, 1484.05f, 520.522f, 1.58261000f },
    { 3895.25f, 1485.82f, 368.226f, 1.56936000f },
    { 3895.26f, 1485.07f, 489.917f, 1.58457000f },
    { 3895.27f, 1484.05f, 459.841f, 1.58405000f },
    { 3895.53f, 1617.47f, 398.912f, 4.82690000f },
    { 3895.62f, 1485.90f, 398.829f, 1.56936000f }
};
...
public:
    ...
    struct boss_jin_qin_xiAI : public BossAI
    {
        ...
        void EnterEvadeMode() override
        {
            ...
            if (instance)
            {
                instance->SetData(DATA_WILL_OF_EMPEROR, FAIL);
                    ...
                    case EVENT_WAIT:
                    {
                        ...
                        break;
                            ...
                            case EVENT_ENERGIZING_SMASH:
                            {
                                ...
                                auto const energized = me->GetAura(SPELL_ENERGIZED);
    ...
    struct mob_ancient_mogu_machineAI : public ScriptedAI
    {
        ...
        void DoAction(const int32 action)
        {
            if (action == ACTION_MOGU_ACTIVATE)
            {
                ...
                events.ScheduleEvent(EVENT_LIGHTNING_COSMETIC, 3 * IN_MILLISECONDS);
            }
            else
                Talk(action);
        }
        ...
        void UpdateAI(const uint32 diff)
        {
            ...
            switch (events.ExecuteEvent())
            {
                ...
                case EVENT_CHECK_WIPE:
                    if (me->GetInstanceScript()->IsWipe())
                    {
                        Reset();

                        if (Creature* jan_xi = me->GetInstanceScript()->instance->GetCreature(me->GetInstanceScript()->GetData64(NPC_JAN_XI)))
                            jan_xi->AI()->DoAction(ACTION_WIPE);

                        if (Creature* qin_xi = me->GetInstanceScript()->instance->GetCreature(me->GetInstanceScript()->GetData64(NPC_QIN_XI)))
...
public:
    ...
    class spell_ernergizing_smash_SpellScript : public SpellScript
    {
        ...
        void SelectTargets(std::list<WorldObject*>& targets)
        {
            ...
            if (Unit* caster = GetCaster())
            {
                auto const energized = caster->GetAura(SPELL_ENERGIZED);
                float dist = 10.0f + (energized ? energized->GetStackAmount() : 0.0f);
    ...
    bool OnGossipHello(Player* player, GameObject* go)
    {
        if (InstanceScript* pInstance = player->GetInstanceScript())
            if (!activated)
            {
                ...
                pInstance->SetData(DATA_WILL_OF_EMPEROR, IN_PROGRESS);
            }
