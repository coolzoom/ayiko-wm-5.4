...
public:
    ...
    {
        sLog->outInfo("misc", "Re-Loading Loot Tables...");
        LoadLootTables();
    ...
    static bool HandleReloadAllQuestCommand(ChatHandler* handler, const char* /*args*/)
    {
        ...
        sLog->outInfo("misc", "Re-Loading Quests Relations...");
    ...
    static bool HandleReloadAllScriptsCommand(ChatHandler* handler, const char* /*args*/)
    {
        ...
        sLog->outInfo("misc", "Re-Loading Scripts...");
    ...
    {
        sLog->outInfo("misc", "Re-Loading config settings...");
    ...
    {
        sLog->outInfo("misc", "Re-Loading Access Requirement definitions...");
    ...
    {
        sLog->outInfo("misc", "Re-Loading Additional Achievement Criteria Data...");
    ...
    {
        sLog->outInfo("misc", "Re-Loading Achievement Reward Data...");
    ...
    {
        sLog->outInfo("misc", "Re-Loading Tavern Area Triggers...");
    ...
    {
        sLog->outInfo("misc", "Re-Loading AreaTrigger teleport definitions...");
    ...
    {
        sLog->outInfo("misc", "Re-Loading Autobroadcasts...");
    ...
    {
        sLog->outInfo("misc", "Re-Loading creature award reputation definitions...");
    ...
    static bool HandleReloadCreatureTemplateCommand(ChatHandler* handler, const char* args)
    {
        ...
        for (Tokenizer::const_iterator itr = entries.begin(); itr != entries.end(); ++itr)
        {
            ...
            sLog->outInfo("misc", "Reloading creature template entry %u", entry);
    ...
    {
        sLog->outInfo("misc", "Loading Quests Relations... (`creature_questrelation`)");
    ...
    {
        sLog->outInfo("misc", "Loading Linked Respawns... (`creature_linked_respawn`)");
    ...
    {
        sLog->outInfo("misc", "Loading Quests Relations... (`creature_involvedrelation`)");
    ...
    {
        sLog->outInfo("misc", "Re-Loading `gossip_menu` Table!");
    ...
    {
        sLog->outInfo("misc", "Re-Loading `gossip_menu_option` Table!");
    ...
    {
        sLog->outInfo("misc", "Re-Loading `guild_rewards` Table!");
    ...
    {
        sLog->outInfo("misc", "Loading Quests Relations... (`gameobject_questrelation`)");
    ...
    {
        sLog->outInfo("misc", "Loading Quests Relations... (`gameobject_involvedrelation`)");
    ...
    {
        sLog->outInfo("misc", "Re-Loading Quest Area Triggers...");
    ...
    {
        sLog->outInfo("misc", "Re-Loading Quest Templates...");
        sObjectMgr->LoadQuests();
        handler->SendGlobalGMSysMessage("DB table `quest_template` (quest definitions) reloaded.");

        /// dependent also from `gameobject` but this table not reloaded anyway
        sLog->outInfo("misc", "Re-Loading GameObjects for quests...");
    ...
    {
        sLog->outInfo("misc", "Re-Loading Loot Tables... (`creature_loot_template`)");
    ...
    {
        sLog->outInfo("misc", "Re-Loading Loot Tables... (`disenchant_loot_template`)");
    ...
    {
        sLog->outInfo("misc", "Re-Loading Loot Tables... (`fishing_loot_template`)");
    ...
    {
        sLog->outInfo("misc", "Re-Loading Loot Tables... (`gameobject_loot_template`)");
    ...
    {
        sLog->outInfo("misc", "Re-Loading Loot Tables... (`item_loot_template`)");
    ...
    {
        sLog->outInfo("misc", "Re-Loading Loot Tables... (`milling_loot_template`)");
    ...
    {
        sLog->outInfo("misc", "Re-Loading Loot Tables... (`pickpocketing_loot_template`)");
    ...
    {
        sLog->outInfo("misc", "Re-Loading Loot Tables... (`prospecting_loot_template`)");
    ...
    {
        sLog->outInfo("misc", "Re-Loading Loot Tables... (`mail_loot_template`)");
    ...
    {
        sLog->outInfo("misc", "Re-Loading Loot Tables... (`reference_loot_template`)");
    ...
    {
        sLog->outInfo("misc", "Re-Loading Loot Tables... (`skinning_loot_template`)");
    ...
    {
        sLog->outInfo("misc", "Re-Loading Loot Tables... (`spell_loot_template`)");
    ...
    {
        sLog->outInfo("misc", "Re-Loading trinity_string Table!");
    ...
    static bool HandleReloadWardenactionCommand(ChatHandler* handler, const char* /*args*/)
    {
        ...
        sLog->outInfo("misc", "Re-Loading warden_action Table!");
    ...
    {
        sLog->outInfo("misc", "Re-Loading `npc_trainer` Table!");
    ...
    {
        sLog->outInfo("misc", "Re-Loading `npc_vendor` Table!");
    ...
    {
        sLog->outInfo("misc", "Re-Loading `points_of_interest` Table!");
    ...
    {
        sLog->outInfo("misc", "Re-Loading Quest POI ..." );
    ...
    {
        sLog->outInfo("misc", "Re-Loading `npc_spellclick_spells` Table!");
    ...
    {
        sLog->outInfo("misc", "Loading ReservedNames... (`reserved_name`)");
    ...
    {
        sLog->outInfo("misc", "Re-Loading `reputation_reward_rate` Table!" );
    ...
    {
        sLog->outInfo("misc", "Re-Loading `reputation_spillover_template` Table!" );
    ...
    {
        sLog->outInfo("misc", "Re-Loading Skill Discovery Table...");
    ...
    {
        sLog->outInfo("misc", "Re-Loading Skill Extra Item Table...");
    ...
    {
        sLog->outInfo("misc", "Re-Loading Skill Fishing base level requirements...");
    ...
    {
        sLog->outInfo("misc", "Re-Loading SpellArea Data...");
    ...
    {
        sLog->outInfo("misc", "Re-Loading Spell Required Data... ");
    ...
    {
        sLog->outInfo("misc", "Re-Loading Spell Groups...");
    ...
    {
        sLog->outInfo("misc", "Re-Loading Spell Learn Spells...");
    ...
    {
        sLog->outInfo("misc", "Re-Loading Spell Linked Spells...");
    ...
    {
        sLog->outInfo("misc", "Re-Loading Spell Proc Event conditions...");
    ...
    {
        sLog->outInfo("misc", "Re-Loading Spell Proc conditions and data...");
    ...
    {
        sLog->outInfo("misc", "Re-Loading Spell Bonus Data...");
    ...
    {
        sLog->outInfo("misc", "Re-Loading Spell target coordinates...");
    ...
    {
        sLog->outInfo("misc", "Re-Loading Aggro Spells Definitions...");
    ...
    {
        sLog->outInfo("misc", "Re-Loading Spell Group Stack Rules...");
    ...
    {
        sLog->outInfo("misc", "Re-Loading Spell pet auras...");
    ...
    {
        sLog->outInfo("misc", "Re-Loading Page Texts...");
    ...
    {
        sLog->outInfo("misc", "Re-Loading Item Random Enchantments Table...");
    ...
    static bool HandleReloadGameObjectScriptsCommand(ChatHandler* handler, const char* args)
    {
        ...
        if (*args != 'a')
            sLog->outInfo("misc", "Re-Loading Scripts from `gameobject_scripts`...");
    ...
    static bool HandleReloadEventScriptsCommand(ChatHandler* handler, const char* args)
    {
        ...
        if (*args != 'a')
            sLog->outInfo("misc", "Re-Loading Scripts from `event_scripts`...");
    ...
    static bool HandleReloadWpScriptsCommand(ChatHandler* handler, const char* args)
    {
        ...
        if (*args != 'a')
            sLog->outInfo("misc", "Re-Loading Scripts from `waypoint_scripts`...");
    ...
    {
        if (*args != 'a')
            sLog->outInfo("misc", "Re-Loading Waypoints data from 'waypoints_data'");
    ...
    static bool HandleReloadQuestEndScriptsCommand(ChatHandler* handler, const char* args)
    {
        ...
        if (*args != 'a')
            sLog->outInfo("misc", "Re-Loading Scripts from `quest_end_scripts`...");
    ...
    static bool HandleReloadQuestStartScriptsCommand(ChatHandler* handler, const char* args)
    {
        ...
        if (*args != 'a')
            sLog->outInfo("misc", "Re-Loading Scripts from `quest_start_scripts`...");
    ...
    static bool HandleReloadSpellScriptsCommand(ChatHandler* handler, const char* args)
    {
        ...
        if (*args != 'a')
            sLog->outInfo("misc", "Re-Loading Scripts from `spell_scripts`...");
    ...
    {
        sLog->outInfo("misc", "Re-Loading Script strings from `db_script_string`...");
    ...
    {
        sLog->outInfo("misc", "Re-Loading Graveyard-zone links...");
    ...
    {
        sLog->outInfo("misc", "Re-Loading Game Tele coordinates...");
    ...
    {
        sLog->outInfo("misc", "Re-Loading disables table...");
        DisableMgr::LoadDisables();
        sLog->outInfo("misc", "Checking quest disables...");
    ...
    {
        sLog->outInfo("misc", "Re-Loading Locales Achievement Reward Data...");
    ...
    {
        sLog->outInfo("misc", "Re-Loading lfg dungeon rewards...");
        sLFGMgr->LoadRewards();
    ...
    {
        sLog->outInfo("misc", "Re-Loading Locales Creature ...");
    ...
    {
        sLog->outInfo("misc", "Re-Loading Locales Creature Texts...");
    ...
    {
        sLog->outInfo("misc", "Re-Loading Locales Gameobject ... ");
    ...
    {
        sLog->outInfo("misc", "Re-Loading Locales Gossip Menu Option ... ");
    ...
    {
        sLog->outInfo("misc", "Re-Loading Locales Item ... ");
    ...
    {
        sLog->outInfo("misc", "Re-Loading Locales NPC Text ... ");
    ...
    {
        sLog->outInfo("misc", "Re-Loading Locales Page Text ... ");
    ...
    {
        sLog->outInfo("misc", "Re-Loading Locales Points Of Interest ... ");
    ...
    {
        sLog->outInfo("misc", "Re-Loading Locales Quest ... ");
    ...
    {
        sLog->outInfo("misc", "Re-Loading Player level dependent mail rewards...");
    ...
    static bool HandleReloadAuctionsCommand(ChatHandler* handler, const char* /*args*/)
    {
        ...
        sLog->outInfo("misc", "Re-Loading Auctions...");
    ...
    {
        sLog->outInfo("misc", "Re-Loading Conditions...");
        sConditionMgr->LoadConditions(true);
    ...
    {
        sLog->outInfo("misc", "Re-Loading Creature Texts...");
    ...
    {
        sLog->outInfo("misc", "Re-Loading Smart Scripts...");
    ...
    {
        sLog->outInfo("misc", "Reloading vehicle_accessory table...");
    ...
    {
        sLog->outInfo("misc", "Reloading vehicle_template_accessory table...");
    ...
    {
        sLog->outInfo("misc", "Reloading script_waypoint table...");
    ...
    {
        sLog->outInfo("misc", "Reloading phase_definitions table...");
    ...
    {
        sLog->outInfo("misc", "Updating Creature Area...");
        ...
        if (!result)
        {
            sLog->outInfo("server.loading", "Updated 0 creature area.");
            return true;
        }
