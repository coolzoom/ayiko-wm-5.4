...
class MotionMaster //: private std::stack<MovementGenerator *>
{
    ...
    public:
        ...
        void MoveSplinePoint(float x, float y, float z, float speed = 0.f, bool walk = true, bool fly = false, Unit* facingTarget = NULL, float orientation = 0.f, bool isFasing = false, bool generatePath = false);
