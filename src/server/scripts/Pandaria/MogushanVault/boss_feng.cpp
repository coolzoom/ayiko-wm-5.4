...
public:
    ...
    struct boss_fengAI : public BossAI
    {
        ...
        {
            events.Reset();
            events.ScheduleEvent(EVENT_SPIRIT_BOLTS, 30 * IN_MILLISECONDS);
        ...
        {
            if (auto const inversion = target->GetAura(115911))
            {
        ...
        void UpdateAI(const uint32 diff)
        {
            ...
            switch (events.ExecuteEvent())
            {
                ...
                case EVENT_SPIRIT_BOLTS:
                {
                    ...
                    events.ScheduleEvent(EVENT_SPIRIT_BOLTS, urand(30 * IN_MILLISECONDS, 40 * IN_MILLISECONDS));
                    break;
                }
                // Shield Phase
