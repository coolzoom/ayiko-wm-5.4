...
struct SpellEffectEntry
{
    ...
    Trinity::Flag128 EffectSpellClassMask;                  // 19-22     m_effectSpellClassMask
...
typedef std::unordered_map<uint32, SpellTotem> SpellTotemMap;
...
struct SpellClassOptionsEntry
{
    ...
    Trinity::Flag128 SpellFamilyFlags;                      // 2-5
