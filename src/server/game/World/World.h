...
enum WorldBoolConfigs
{
	...
	CONFIG_ENABLE_BATTLEFIELDS,
	CONFIG_APRIL_FOOLS_NO_FLYING,
	CONFIG_APRIL_FOOLS_FFA,
	CONFIG_APRIL_FOOLS_PERMA_DEATH,
...
enum WorldFloatConfigs
{
    ...
    CONFIG_CHEAT_MOVING_TELEPORT_DISTANCE_DETECT,
    CONFIG_CHEAT_MOVING_MAX_SPEED_MULTIPLIER,
...
enum WorldIntConfigs
{
    ...
    CONFIG_ARENA_BASE_RATING_DIFFERENCE,
    CONFIG_ARENA_RATING_DIFFERENCE_UPDATE_TIMER,
    CONFIG_ARENA_RATING_DIFFERENCE_UPDATE_STEP,
...
enum WorldStates
{
    ...
    WS_PROFESSION_CD_RESET_TIME = 20005,                     // Next profession cooldown reset time
};
...
class World
{
    public:
        ...
        time_t GetNextProfessionCooldownResetTime() const { return m_NextProfessionCooldownReset; }
    ...
    private:
        ...
        void InitProfessionCooldownResetTime();
        ...
        time_t m_NextProfessionCooldownReset;
