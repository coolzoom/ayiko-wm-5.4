...
enum CreatureFlagsExtra
{
    ...
    CREATURE_FLAG_EXTRA_DISABLED_LOS    = 0x20000000,       // LoS checks disabled for creature, bool WorldObject::IsWithinLOSInMap will always return true
    CREATURE_FLAG_EXTRA_TRAINING_DUMMY  = 0x40000000
};
...
#define CREATURE_FLAG_EXTRA_DB_ALLOWED (CREATURE_FLAG_EXTRA_INSTANCE_BIND | CREATURE_FLAG_EXTRA_CIVILIAN | \
    ...
    CREATURE_FLAG_EXTRA_GUARD | CREATURE_FLAG_EXTRA_DISABLED_LOS)
...
class Creature : public Unit, public GridObject<Creature>, public MapCreature
{
    public:
        ...
        bool isLosDisabled() const { return GetCreatureTemplate()->flags_extra & CREATURE_FLAG_EXTRA_DISABLED_LOS; }
