    ...
    struct boss_commander_rimokAI : public BossAI
    {
        ...
        void UpdateAI(const uint32 diff) override
        {
            ...
            case EVENT_VISCOUS_FLUID:
                me->CastSpell(me, SPELL_VISCOUS_FLUID_SPAWN, false);
                me->CastSpell(me, SPELL_VISCOUS_FLUID, true);
                events.ScheduleEvent(EVENT_VISCOUS_FLUID, urand(15, 20) * IN_MILLISECONDS);
                break;
            }
