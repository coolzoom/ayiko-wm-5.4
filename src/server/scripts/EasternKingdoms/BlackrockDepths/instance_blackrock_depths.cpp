...
public:
    ...
    struct instance_blackrock_depths_InstanceMapScript : public InstanceScript
    {
        ...
        {
            sLog->outDebug("scripts", "Instance Blackrock Depths: SetData64 update (Type: %u Data " UI64FMTD ")", type, data);
        ...
        {
            sLog->outDebug("scripts", "Instance Blackrock Depths: SetData update (Type: %u Data %u)", type, data);
