...
void WaypointMovementGenerator<Creature>::LoadPath(Creature *creature)
{
    ...
    if (!i_path)
    {
        ...
        sLog->outError(LOG_FILTER_SQL, "WaypointMovementGenerator::LoadPath: creature %s (Entry: %u GUID: %u) doesn't have waypoint path id: %u",
...
void WaypointMovementGenerator<Creature>::OnArrived(Creature* creature)
{
    ...
    {
        sLog->outDebug(LOG_FILTER_MAPSCRIPTS, "Creature movement start script %u at point %u for " UI64FMTD ".",
...
void FlightPathMovementGenerator::DoReset(Player *player)
{
    ...
    // Percentage from SPELL_AURA_MOD_TAXI_FLIGHT_SPEED
