...
enum RBACPermissions
{
    ...
    RBAC_PERM_COMMAND_RBAC_ACC_PERM_CHECK                    = 207,
    // 208 - reuse
    // 209 - reuse
    // 210 - reuse
    // 211 - reuse
    ...
    RBAC_PERM_SKIP_CHECK_SAY_OR_YELL_REQ                     = 1001,
    RBAC_PERM_USE_CALENDAR                                   = 1002,
    RBAC_PERM_SKIP_CHECK_WHO_SPAM                            = 1003,
    RBAC_PERM_COMMAND_ACHIEVEMENT_CRITERIA                   = 1004,
    RBAC_PERM_COMMAND_ACHIEVEMENT_CHECK                      = 1005,
    RBAC_PERM_COMMAND_ACHIEVEMENT_START                      = 1006,
    RBAC_PERM_COMMAND_GUILD_RANK_CREATE                      = 1007,
    RBAC_PERM_COMMAND_GUILD_RANK_DELETE                      = 1008,
    RBAC_PERM_COMMAND_GUILD_VALIDATE                         = 1009,
    RBAC_PERM_COMMAND_GUILD_RESETTIMES                       = 1010,
    RBAC_PERM_COMMAND_GOBJECT_DAMAGE                         = 1011,
    RBAC_PERM_COMMAND_GOBJECT_DESTROY                        = 1012,
    RBAC_PERM_COMMAND_QANNOUNCE                              = 1013,
    RBAC_PERM_COMMAND_TGPS                                   = 1014,
    RBAC_PERM_COMMAND_MODIFY_RATING                          = 1015,
    RBAC_PERM_COMMAND_RELOAD_PHASEDEFINITIONS                = 1016,
    RBAC_PERM_COMMAND_RELOAD_QUEST_END_SCRIPTS               = 1017,
    RBAC_PERM_COMMAND_RELOAD_QUEST_START_SCRIPTS             = 1018,
    RBAC_PERM_COMMAND_RESET_CURRENCY_CAP                     = 1019,
    RBAC_PERM_COMMAND_SERVER_DIFF                            = 1020,
    RBAC_PERM_COMMAND_SERVER_DIFF_LAST                       = 1021,
    RBAC_PERM_COMMAND_SERVER_DIFF_AVERAGE                    = 1022,
    RBAC_PERM_COMMAND_SERVER_DIFF_INTERVAL                   = 1023,
    RBAC_PERM_COMMAND_TICKET_CLOSEFIRST                      = 1024,
    RBAC_PERM_COMMAND_TICKET_DELETEFIRST                     = 1025,
    RBAC_PERM_COMMAND_TICKET_VIEWFIRST                       = 1026,
    RBAC_PERM_COMMAND_RELOAD_SPAM_KEYWORDS                   = 1027,
    RBAC_PERM_COMMAND_GUILD_RANK_SWITCH                      = 1028,
    RBAC_PERM_COMMAND_GUILD_INFO                             = 1029,
    RBAC_PERM_COMMAND_RELOAD_NPC_GOSSIP                      = 1030,
    RBAC_PERM_COMMAND_RELOAD_CREATURE_AI_SUMMONS             = 1031,
    RBAC_PERM_COMMAND_RELOAD_GAMEOBJECT_SCRIPTS              = 1032,
    RBAC_PERM_COMMAND_RELOAD_GOSSIP_SCRIPTS                  = 1033,
    RBAC_PERM_COMMAND_NPC_SET_DEATHSTATE                     = 1034,
    RBAC_PERM_COMMAND_CHANNEL_SET_PUBLIC                     = 1035,
    RBAC_PERM_COMMAND_FLUSH_ARENAPOINTS                      = 1036,
    RBAC_PERM_COMMAND_HOVER                                  = 1037,
    RBAC_PERM_COMMAND_START                                  = 1038,
    RBAC_PERM_COMMAND_SUSPECT                                = 1039,
    RBAC_PERM_COMMAND_UNSUSPECT                              = 1040,
    RBAC_PERM_COMMAND_BG                                     = 1041,
    RBAC_PERM_COMMAND_BG_QUEUE                               = 1042,
    RBAC_PERM_COMMAND_BG_STATS                               = 1043,
    RBAC_PERM_COMMAND_BG_STATS_FULL                          = 1044,
    RBAC_PERM_COMMAND_BG_STATS_CLEAR                         = 1045,
    RBAC_PERM_COMMAND_BG_STATS_RANDOM                        = 1046,
