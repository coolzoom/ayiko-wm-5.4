...
enum Belnistrasz
{
    ...
    QUEST_EXTINGUISHING_THE_IDOL = 27022,
...
public:
    ...
    CreatureAI* GetAI(Creature* creature) const override
    {
        return GetInstanceAI<npc_belnistraszAI>(creature, RFDScriptName);
    }
};
...
public:
    ...
    CreatureAI* GetAI(Creature* creature) const override
    {
        return GetInstanceAI<npc_idol_room_spawnerAI>(creature, RFDScriptName);
    }
};
...
public:
    ...
    CreatureAI* GetAI(Creature* creature) const override
    {
        return GetInstanceAI<npc_tomb_creatureAI>(creature, RFDScriptName);
    }
};
