...
// strtoull doesn't exist on WIN
        ...
        moneyToAdd = _strtoui64(args, NULL, 10);
#else
        moneyToAdd = strtoull(args, NULL, 10);
#endif
        ...
        TC_LOG_DEBUG("misc", handler->GetTrinityString(LANG_NEW_MONEY), targetMoney, uint32(moneyToAdd), target->GetMoney());
        return true;
    }
