...
const char BattlemasterListEntryfmt[]         = "niiiiiiiiiiixxxxxixsiiiiixxxxx";
...
const char ChrSpecializationsfmt[]            = "nxiixixixxxxxx";
...
const char LFGDungeonEntryfmt[]               = "nxiiiiiiiiixxixixiiiixxxxiixx";
...
const char SpellItemEnchantmentfmt[]          = "nxiiiiiiiiisiiiiiiiixixfff";
const char SpellItemEnchantmentConditionfmt[] = "nbbbbbxxxxxbbbbbbbbbbiiiiixxxxx";
const char SpellRadiusfmt[]                   = "nfxxf";
const char SpellRangefmt[]                    = "nffffixx";
const char SpellScalingEntryfmt[]             = "diiiifiix";
...
const char SpellPowerEntryfmt[]               = "niiiiiiiiffif";
...
const char WMOAreaTableEntryfmt[]             = "niiixxxxxiisxxx";
