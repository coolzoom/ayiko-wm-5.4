...
class instance_icecrown_citadel : public InstanceMapScript
{
    public:
        ...
        struct instance_icecrown_citadel_InstanceMapScript : public InstanceScript
        {
            ...
            Creature * SpawnTransportNpc(Transport * /*pTransport*/, uint32 /*npc_entry*/ = 0,
                                         float /*TransOffsetX*/ = 0, float /*TransOffsetY*/ = 0, float /*TransOffsetZ*/ = 0, float /*TransOffsetO*/ = 0,
                                         uint32 /*emote*/ = 0)
            {
                return NULL;
            }
            ...
            void DoPortalEvent()
            {
                ...
                switch (GunshipPortalPhase)
                {
                    case 1:
                    {
                        Creature * portal = m_GunshipMain->AddNPCPassengerInInstance(0, NPC_GUNSHIP_PORTAL, x, y, z, o);
                ...
                if (npcToAdd)
                {
                    if (Creature* soldier = m_GunshipMain->AddNPCPassengerInInstance(0, npcToAdd, x, y, z, o))
