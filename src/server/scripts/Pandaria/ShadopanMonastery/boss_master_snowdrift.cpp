...
Position const SnowdriftPos[2] =
{
    {3680.56f, 3045.27f, 816.20f, 0.0f},
    {3713.60f, 3091.87f, 817.31f, 0.0f}
};

Position const InitiateSpawnPos[5] =
{
    {3708.56f, 3039.60f, 816.28f, 0.0f},
    {3699.19f, 3049.62f, 816.28f, 0.0f},
    {3688.03f, 3055.68f, 816.28f, 0.0f},
    {3675.10f, 3066.98f, 816.28f, 0.0f},
    {3668.95f, 3070.81f, 816.28f, 0.0f}
};

Position const MinibossSpawnPos[2] =
{
    {3683.72f, 3053.94f, 816.28f, 0.0f},
    {3687.77f, 3051.30f, 816.28f, 0.0f}
};

Position const ClonePos[3] =
{
