...
Liste cr�atures :
NEUTRE :
    37227 - Portail de t�l�portation
...
69705 - En dessous de z�ro

-- Sorts Soldat-Artilleur/Missilier
69679 - Artillerie � roquettes

-- Sorts Sergents
69651 - 72570 - Frappe de l�sion
69647 - 72537 - R�solution d�sesp�r�e
69652 - Temp�te de lames
//Poix ardente
...
public:
    ...
    struct npc_gunship_commander_AI : public ScriptedAI
    {
        ...
        void DamageTaken(Unit* /*pDone_by*/, uint32& uiDamage)
        {
            ...
            if(uiDamage >= me->GetHealth()) // Les commandants ne sont pas cens�s mourir
                uiDamage = 0;
        }
...
public:
    ...
    struct npc_gunship_AI : public ScriptedAI
    {
        ...
        void DoAction(const int32 actionId)
        {
            switch(actionId)
            {
                // D�fini au summon si le pnj s'occupe de la canno amie(true) ou ennemie(false)
