...
void BigNumber::SecureDeleter::operator()(char *ptr)
{
    OPENSSL_free(ptr);
}
...
BigNumber::Str BigNumber::AsHexStr() const
{
    return Str(BN_bn2hex(_bn));
}

BigNumber::Str BigNumber::AsDecStr() const
{
    return Str(BN_bn2dec(_bn));
}
